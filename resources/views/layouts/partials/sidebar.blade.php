        ...
        <div id="sidebar-menu">
            <ul class="sidebar-links custom-scrollbar">
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="bookmark"></i><span>Data Pinjaman</span>
                    ...
                    <ul class="sidebar-submenu">
                        <li><a href="{{ route('admin.datapinjaman.pending') }}">Pending</a></li>
                        <li><a href="{{ route('admin.datapinjaman.approve') }}">Approve</a></li>
                    </ul>
                </li>
                ...
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{ route('home') }}"><i data-feather="home"> </i><span>Dashboard</span></a></li>
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{ route('home') }}"><i data-feather="box"> </i><span>Kalkulator</span></a></li>
                @if(auth()->user()->email_verified_at != null)
                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="{{ route('user.pinjaman.index') }}"><i data-feather="book"> </i><span>Pinjaman</span></a></li>
                @endif
                @endif
            </ul>
=======
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links custom-scrollbar">
                    ...
                    {{-- @if(auth()->user()->role == 'admin') --}}
                        ...
                        <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="file"></i></i><span>Detail Data Angsuran</span>
                            </a>
                            <ul class="sidebar-submenu">
                                <li><a href="{{ route('admin.detaildata.angsuranke') }}">Angsuran Ke</a></li>
                                <li><a href="{{ route('admin.detaildata.pokok') }}">Pokok</a></li>
                        ...
                        <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="file-text"></i><span>Detail Data Pinjaman</span></a>
                            <ul class="sidebar-submenu">
                                <li><a href="">Approved</a></li>
                                <li><a href="">Belum di Approve</a></li>
                            </ul>
                        </li>
                        <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="#"><i data-feather="user-check"></i><span>Verifikasi User</span></a></li>
    ...
    @if(auth()->user()->role == "1")
        <div class="logo-wrapper">
            ...
            <div class="back-btn"><i class="fa fa-angle-left"></i></div>
            <div class="toggle-sidebar"><i class="status_toggle middle sidebar-toggle" data-feather="grid"> </i></div>
>>>>>>> 7ca1c4a57535ef0d295e668eadda201424d5b546
        </div>
        <div class="logo-icon-wrapper">
            <a href="{{ route('home') }}"><img class="img-fluid" src="{{ asset('assets/images/logo/logoweb.png') }}" alt="logowebsite" style="height: 20px; width: 20px; object-fit: cover;"></a>
        </div>
